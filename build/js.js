...
const Instrument = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement('input', { type: 'text', onChange: this._changedOffset, value: this.state.offset }),
      React.createElement('input', { type: 'text', onChange: this._changedDelay, value: this.state.delay }),
      React.createElement('input', { type: 'text', onChange: this._changedStop, value: this.state.stop })
    );
  },
...
},{"./instrument":1,"react":168,"react-dom":5,"soundfont-player":172}],4:[function(require,module,exports){
